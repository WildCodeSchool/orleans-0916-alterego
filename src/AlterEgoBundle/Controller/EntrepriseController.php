...
use AlterEgoBundle\Entity\Entreprise;
...
class EntrepriseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entreprises = $em->getRepository('AlterEgoBundle:Entreprise')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AlterEgoBundle\Form\EntrepriseType', $entreprise);
    ...
    {
        $deleteForm = $this->createDeleteForm($entreprise);
        $editForm = $this->createForm('AlterEgoBundle\Form\EntrepriseType', $entreprise);
